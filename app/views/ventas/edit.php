...
<div class="container">
    <div class="page-header">
        <h1><i class="fas fa-edit"></i> Editar Venta #<?php echo $venta['id']; ?></h1>
    ...
    <div class="venta-edit-container">
        ...
        <div class="edit-form-card">
            ...
            <div class="card-body">
                <form action="/sistema/?route=ventas/update/<?php echo $venta['id']; ?>" method="post" class="edit-form">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="id_caja" id="id_caja" required>
                                ...
                                <?php foreach ($cajas as $caja): ?>
                                    <option value="<?php echo $caja['id']; ?>" <?php echo ($venta['id_caja'] == $caja['id']) ? 'selected' : ''; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_tipo_pago" id="id_tipo_pago" required>
                                <option value="">Seleccionar Tipo de Pago</option>
                                <?php foreach ($tiposPago as $tipo): ?>
                                    <option value="<?php echo $tipo['id']; ?>" <?php echo ($venta['id_tipo_pago'] == $tipo['id']) ? 'selected' : ''; ?>>
        ...
        <div class="productos-card">
            <div class="card-header">
                ...
                <small class="text-muted">Solo lectura - Los productos no se pueden modificar</small>
            </div>
            <div class="card-body">
...
.venta-info-card, .edit-form-card, .productos-card {
    background: white;
    border-radius: 12px;
